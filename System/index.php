...
<head>
    ...
    <meta property="" content="JOB-PORTAL" />
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
<a href="./" style="color:white"><strong>JOB-PORTAL  <strong>
						</div>
					</div>
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="employers.php" style="text-transform:uppercase">Employers</a>
							</li>
							
							<li>
								<a href="employees.php" style="text-transform:uppercase">Employees</a>
							</li>
		...
		<div class="hero" style="background-image:url('images/hero-header/01.JFIF');">
				<div class="container">
<br/>				<br/>
				<br/>
					<h1>Your Bright Future Starts Here Now</h1>
					<p>Get Your Right Job Here</p><br/>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
							...
							<br><h2 style="text-transform:uppercase">Random-Companies</h2>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
							...
							<br><h2 style="text-transform:uppercase">Latest-Jobs</h2>
